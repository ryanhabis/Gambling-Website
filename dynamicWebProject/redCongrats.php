...
<!--Taken from youtube -->
        ...
        <div class = 'productDetails'>
            <label class = 'theProduct'><u>Product ID</u> &nbsp;&nbsp;</label>1;<br><br>
            <label class = 'theProduct'><u>Product Name</u> &nbsp;&nbsp;</label>Car;<br><br>
            <label class = 'theProduct'><u>Product Image</u> &nbsp;&nbsp;</label><img src='images/products/car.jpg' width='250' /><br><br>
            <label class='theProduct'><u>Product Description</u>: &nbsp;&nbsp;</label>winning prize<br><br>
            <label class='theProduct'><u>Product Description</u>: &nbsp;&nbsp;</label>99999999.99;<br><br><br><br><br>
        </div>
