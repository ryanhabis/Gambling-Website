...
<!--Taken from youtube -->
        ...
        <div class = 'productDetails'>
            <label class = 'theProduct'><u>Product ID</u> &nbsp;&nbsp;</label>7;<br><br>
            <label class = 'theProduct'><u>Product Name</u> &nbsp;&nbsp;</label>Painting 4;<br><br>
            <label class = 'theProduct'><u>Product Image</u> &nbsp;&nbsp;</label><img src='images/products/paint4.jpg' width='250' /><br><br>
            <label class='theProduct'><u>Product Description</u>: &nbsp;&nbsp;</label>checkmate<br><br>
            <label class='theProduct'><u>Product Description</u>: &nbsp;&nbsp;</label>90000000.00;<br><br><br><br><br>
        </div>
