...
<!--Taken from youtube -->
        ...
        <div class = 'productDetails'>
            <label class = 'theProduct'><u>Product ID</u> &nbsp;&nbsp;</label>2;<br><br>
            <label class = 'theProduct'><u>Product Name</u> &nbsp;&nbsp;</label>T-Shirt;<br><br>
            <label class = 'theProduct'><u>Product Image</u> &nbsp;&nbsp;</label><img src='images/products/tShirt.jpg' width='250' /><br><br>
            <label class='theProduct'><u>Product Description</u>: &nbsp;&nbsp;</label>winning shirt<br><br>
            <label class='theProduct'><u>Product Description</u>: &nbsp;&nbsp;</label>50.00;<br><br><br><br><br>
        </div>
