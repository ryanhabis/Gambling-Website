...
<!--Taken from youtube -->
        ...
        <div class = 'productDetails'>
            <label class = 'theProduct'><u>Product ID</u> &nbsp;&nbsp;</label>6;<br><br>
            <label class = 'theProduct'><u>Product Name</u> &nbsp;&nbsp;</label>Painting 3;<br><br>
            <label class = 'theProduct'><u>Product Image</u> &nbsp;&nbsp;</label><img src='images/products/paint3.jpg' width='250' /><br><br>
            <label class='theProduct'><u>Product Description</u>: &nbsp;&nbsp;</label>sit comfortably<br><br>
            <label class='theProduct'><u>Product Description</u>: &nbsp;&nbsp;</label>25000000.00;<br><br><br><br><br>
        </div>
